...
export const SKILLS: Record<SkillNames, Skill> = {
  ...
  [SkillNames.ANGULAR]: {
    ...
    name: "angular",
    label: "Angular",
    shortDescription: "building scalable SPAs with clean architecture and RxJS flows 🅰️",
    color: "#dd0031",
  ...
  [SkillNames.SPRING_BOOT]: {
    ...
    name: "Spring Boot",
    label: "Spring Boot",
    shortDescription: "crafting secure Java APIs and microservices ready for production ☕",
    color: "#6db33f",
